export const contentData = [
  {
    ...
    items: [
      {
        title: "Software Engineer Inter at Tesla",
        subTitle: "Fremont, US",
        date: "05/24 - Present",
        description:
          "Building some new products. Wielding Angular and .NET with ease. ",
      },
      {
        ...
        date: "12/23 - 02/24",
        description:
          "Built the majority of the Kimi app, including the frontend, backend, database, logging, AI engineering, and CI/CD.\
      ...
      },
      {
        ...
        date: "02/23 - 04/23",
        description:
          "Developed Windows SDK using .NET framework for Dolby Vision color profile generation \
